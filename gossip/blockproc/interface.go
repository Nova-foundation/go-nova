...
type EVM interface {
	Start(block iblockproc.BlockCtx, statedb *state.StateDB, reader evmcore.DummyChain, onNewLog func(*types.Log), net nova.Rules, evmCfg *params.ChainConfig) EVMProcessor
}
