...
// Source: github.com/Nova-foundation/go-nova/gossip/emitter (interfaces: External,TxPool,TxSigner,Signer)

// Package mock is a generated GoMock package.
package mock

import (
	evmcore "github.com/Nova-foundation/go-nova/evmcore"
	inter "github.com/Nova-foundation/go-nova/inter"
	validatorpk "github.com/Nova-foundation/go-nova/inter/validatorpk"
	nova "github.com/Nova-foundation/go-nova/nova"
	vecmt "github.com/Nova-foundation/go-nova/vecmt"
...
func (m *MockExternal) GetRules() nova.Rules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(nova.Rules)
	return ret0
}
