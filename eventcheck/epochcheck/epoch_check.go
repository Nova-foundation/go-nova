...
type Reader interface {
	base.Reader
	GetEpochRules() (nova.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules nova.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules nova.Rules) error {
...
func CheckTxs(txs types.Transactions, rules nova.Rules) error {
	maxType := uint8(0)
