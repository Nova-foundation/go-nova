...
var (
	walletCommand = cli.Command{
		...
		Description: `
    nova wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	nova wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    nova account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    nova account import [options] <keyfile>
